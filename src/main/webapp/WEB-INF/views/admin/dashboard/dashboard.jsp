				...
				<div class="card">
					...
					<div class="container p-3">
						<div class="row">
							<!-- Phần chiếm 4 cột -->
							<div class="col-md-4">
								<dt class = "mb-2">Tìm kiếm tùy chọn</dt>
								<div class="mb-3">
                    ...
                    <path d="M21 21l-6 -6" />
								...
								<dt class="mt-3 ms-1 mb-2">Tìm kiếm theo Tuần / Tháng / Năm</dt>
							...
							<tbody>
								<tr>
									...
									<td class="td-truncate">
										<div class="text-truncate">Fix dart Sass compatibility
											(#29755)</div>
									</td>
									<td class="text-nowrap text-secondary">28 Nov 2019</td>
								</tr>
								<tr>
									<td class="w-1"><span class="avatar avatar-sm">JL</span></td>
									<td class="td-truncate">
										<div class="text-truncate">Change deprecated html tags
											to text decoration classes (#29604)</div>
									</td>
								...
								<tr>
									...
									<td class="td-truncate">
										<div class="text-truncate">justify-content:between â
								...
								<tr>
									...
									<td class="td-truncate">
										<div class="text-truncate">Regenerate package-lock.json
											(#29730)</div>
									</td>
						...
						<div class="row align-items-center">
							<div class="col-10">
								...
								<div class="markdown text-secondary">
									...
									Visit <a href="https://tabler-icons.io" target="_blank"
										rel="noopener">tabler-icons.io</a>, download any of the 4637
									icons in SVG, PNG or&nbsp;React and use them in your favourite
									design tools.
								</div>
								<div class="mt-3">
				...
				<div class="card">
					...
					<div class="card-table table-responsive">
						<table class="table table-vcenter">
							...
							<tr>
								<td>/form-elements.html <a href="#" class="ms-1"
							...
							<tr>
								<td>/index.html <a href="#" class="ms-1"
									aria-label="Open website"> <!-- Download SVG icon from http://tabler-icons.io/i/link -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
											width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
											stroke="currentColor" fill="none" stroke-linecap="round"
							...
							<tr>
								<td>/icons.html <a href="#" class="ms-1"
									aria-label="Open website"> <!-- Download SVG icon from http://tabler-icons.io/i/link -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
											width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
											stroke="currentColor" fill="none" stroke-linecap="round"
							...
							<tr>
								<td>/accordion.html <a href="#" class="ms-1"
									aria-label="Open website"> <!-- Download SVG icon from http://tabler-icons.io/i/link -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
											width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
											stroke="currentColor" fill="none" stroke-linecap="round"
							...
							<tr>
								...
								<td class="text-nowrap text-secondary">
									...
									<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
										...
										<path d="M4 11h16" />
										<path d="M11 15h1" />
										<path d="M12 15v3" /></svg> August 04, 2021
								</td>
								<td class="text-nowrap"><a href="#" class="text-secondary">
							...
							<tr>
								...
								<td class="text-nowrap text-secondary">
									...
									<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
										...
										<path d="M4 11h16" />
										<path d="M11 15h1" />
										<path d="M12 15v3" /></svg> January 03, 2019
								</td>
								<td class="text-nowrap"><a href="#" class="text-secondary">
										<!-- Download SVG icon from http://tabler-icons.io/i/check -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
							...
							<tr>
								...
								<td class="text-nowrap text-secondary">
									...
									<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
										...
										<path d="M4 11h16" />
										<path d="M11 15h1" />
										<path d="M12 15v3" /></svg> December 28, 2018
								</td>
								<td class="text-nowrap"><a href="#" class="text-secondary">
										<!-- Download SVG icon from http://tabler-icons.io/i/check -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
							...
							<tr>
								...
								<td class="text-nowrap text-secondary">
									...
									<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
										...
										<path d="M4 11h16" />
										<path d="M11 15h1" />
										<path d="M12 15v3" /></svg> November 07, 2020
								</td>
								<td class="text-nowrap"><a href="#" class="text-secondary">
										<!-- Download SVG icon from http://tabler-icons.io/i/check -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
							...
							<tr>
								...
								<td class="text-nowrap text-secondary">
									...
									<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
										...
										<path d="M4 11h16" />
										<path d="M11 15h1" />
										<path d="M12 15v3" /></svg> November 23, 2021
								</td>
								<td class="text-nowrap"><a href="#" class="text-secondary">
										<!-- Download SVG icon from http://tabler-icons.io/i/check -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
							...
							<tr>
								...
								<td class="text-nowrap text-secondary">
									...
									<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
										...
										<path d="M4 11h16" />
										<path d="M11 15h1" />
										<path d="M12 15v3" /></svg> January 14, 2021
								</td>
								<td class="text-nowrap"><a href="#" class="text-secondary">
										<!-- Download SVG icon from http://tabler-icons.io/i/check -->
										<svg xmlns="http://www.w3.org/2000/svg" class="icon"
